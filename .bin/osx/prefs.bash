...
sudo /usr/sbin/scutil --set ComputerName $1
sudo /usr/sbin/scutil --set HostName $1
...
# osascript -e 'tell application "Finder" to set desktop picture to POSIX file "~/Pictures/desktop.jpg"'
...
# Set tracking speed slightly below max for mouse and trackpad
...
# Hide external media on Desktop
...
# Sort Activity Monitor results by Memory usage
defaults write com.apple.ActivityMonitor SortColumn -string "Memory"
