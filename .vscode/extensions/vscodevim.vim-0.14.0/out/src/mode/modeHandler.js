...
class ModeHandler {
    constructor() {
        ...
        this.vimState = new vimState_1.VimState(vscode.window.activeTextEditor);
    ...
    updateView(vimState, args = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            cursorStyle =
                configuration_1.configuration.modeToCursorStyleMap[this.currentMode.friendlyName.toLowerCase()] ||
                    cursorStyle;
            ...
            */
            ...
            this._renderStatusBar();
            yield vscode.commands.executeCommand('setContext', 'vim.mode', mode_1.ModeName[this.vimState.currentMode]);
        });
    }
    _renderStatusBar() {
        ...
        if (configuration_1.configuration.statusBarColorControl) {
            ...
            if (colorToSet !== undefined) {
                ...
                statusBar_1.StatusBar.SetColor(background, foreground);
            }
        }
        let text = [];
