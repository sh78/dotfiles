            ...
            try {
                ...
                if (this.arguments.bang) {
                    fs.chmod(vimState.editor.document.fileName, 666, e => {
                        ...
                        statusBar_1.StatusBar.SetText(e.message, vimState.currentMode, vimState.isRecordingMacro, true);
                        return;
                    });
                }
                else {
                    statusBar_1.StatusBar.SetText(accessErr.message, vimState.currentMode, vimState.isRecordingMacro, true);
                }
            }
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield vimState.editor.document.save().then(() => {
                let text = '"' +
                    ...
                    'C written';
                statusBar_1.StatusBar.SetText(text, vimState.currentMode, vimState.isRecordingMacro, true);
            }, e => statusBar_1.StatusBar.SetText(e, vimState.currentMode, vimState.isRecordingMacro, true));
        });
    }
}
