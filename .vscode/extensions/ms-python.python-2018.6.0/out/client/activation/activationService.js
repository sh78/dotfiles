...
let ExtensionActivationService = class ExtensionActivationService {
    ...
    onDidChangeConfiguration(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const item = yield this.appShell.showInformationMessage('Please reload the window switching between the analysis engines.', 'Reload');
            if (item === 'Reload') {
    ...
    useJedi() {
        ...
        return !constants_1.isPythonAnalysisEngineTest() && jediEnabledForAnyWorkspace;
    }
};
