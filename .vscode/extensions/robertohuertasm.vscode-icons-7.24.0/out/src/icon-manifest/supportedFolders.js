...
exports.extensions = {
    ...
    supported: [
        ...
        { icon: 'dist', extensions: ['dist', 'out', 'export', 'build', 'release', 'target'], format: models_1.FileFormat.svg },
        ...
        { icon: 'typings', extensions: ['typings', '@types'], format: models_1.FileFormat.svg },
        { icon: 'typings2', extensions: ['typings', '@types'], format: models_1.FileFormat.svg, disabled: true },
        { icon: 'vagrant', extensions: ['vagrant', '.vagrant'], format: models_1.FileFormat.svg },
        { icon: 'video', extensions: ['video', '.video', 'videos', '.videos'], format: models_1.FileFormat.svg },
